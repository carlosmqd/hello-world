...
<html>
  ...
  <body>
    <div id="container">
      <div class="col-md-12 galeria">
	    ...
	    <div class="caraousel-tooltip-item " data-index="3" style='display:none;'>
        <a href="#" class="tooltip-carousel" style="top:300px;left: 300px;padding:5px 10px;background:#f00;color:#fff;display:none" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Informacion extra  1.1">
          <span class="fa fa-check fa-2x"></span>
        </a>
        ...
        <a href="https://rb-wam.bosch.com/socos-c/SOCOS/display.fcgi?exportExcel=0&lang=en&standard=&area=00000&def_disp_lang=en&abbr=&headline=&mode=0&searchstr=CD-04602-003&topicsAll=&orgAll=" class="tooltip-carousel" style="top:150px;left: 435px;padding:5px 10px;background:#00f;color:#fff;display:inline-block" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Revisar Página" target="_blank">
          <span class="fa fa-link fa"></span>
        </a>
        <a href="https://bgn.bosch.com/alias/SC-ITM " class="tooltip-carousel" style="top:220px;left: 600px;padding:5px 10px;background:#00f;color:#fff;display:inline-block" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Revisar Página" target="_blank">
          <span class="fa fa-link fa"></span>
        </a>
      </div>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active" id="1">
              <img src="../../media/presentacion/modulo1/Slide1.jpg" class="img-responsive">
            ...
            <div class="item" id="2">
              <img src="../../media/presentacion/modulo1/Slide2.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
            </div>
            <div class="item" id="3">
              <img src="../../media/presentacion/modulo1/Slide3.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
            </div>
            <div class="item" id="4">
              <img src="../../media/presentacion/modulo1/Slide4.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
               
              </div>
            </div>
            <div class="item" id="5">
              <img src="../../media/presentacion/modulo1/Slide5.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			   <div class="item" id="6">
              <img src="../../media/presentacion/modulo1/Slide6.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			  <div class="item" id="7">
              <img src="../../media/presentacion/modulo1/Slide7.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			  <div class="item" id="8">
              <img src="../../media/presentacion/modulo1/Slide8.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			   <div class="item" id="9">
              <img src="../../media/presentacion/modulo1/Slide9.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			  <div class="item" id="10">
              <img src="../../media/presentacion/modulo1/Slide10.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
  ...
  case "5":
    ...
    setTimeout(function(){ right.style.display = "";left.style.display = ""; div.textContent = mytext2; },delayMillis);
	  ...
	  window.location='vistas/validar_curso.php?modulo=1';
