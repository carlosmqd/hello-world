...
<html>
        ...
        <div id="carousel-1" class="carousel slide" data-ride="carousel" data-interval="false" >
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active" id="1">
              <img src="../../media/presentacion/modulo4/Slide1.jpg" class="img-responsive">
            ...
            <div class="item" id="2">
              <img src="../../media/presentacion/modulo4/Slide2.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
            </div>
            <div class="item" id="3">
              <img src="../../media/presentacion/modulo4/Slide3.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
            </div>
            <div class="item" id="4">
              <img src="../../media/presentacion/modulo4/Slide4.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
               
              </div>
            </div>
            <div class="item" id="5">
              <img src="../../media/presentacion/modulo4/Slide5.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			   <div class="item" id="6">
              <img src="../../media/presentacion/modulo4/Slide6.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
                
              </div>
			  </div>
			  <div class="item" id="7">
              <img src="../../media/presentacion/modulo4/Slide7.jpg" class="img-responsive">
              <div class="carousel-caption hidden-xs hidden-sm">
  ...
  case "5":
    ...
    setTimeout(function(){ right.style.display = "";left.style.display = ""; div.textContent = mytext2; },delayMillis);
	  ...
	  window.location='vistas/validar_curso.php?modulo=4';
